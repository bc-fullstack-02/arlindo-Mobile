...
import { Auth, UserToken } from "../components/AuthForm";
...
const defaultValue: IAuthContextData = {
    token: null,
    user: null,
    profile: null,
    isLoading: true,
...
const Context = React.createContext<IAuthContextData>(defaultValue);
...
export { Provider, Context, useAuthContext };